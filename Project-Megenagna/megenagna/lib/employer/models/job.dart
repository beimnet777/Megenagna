...
class Job {
  ...
  factory Job.fromJson(Map<String, dynamic> json) {
    var tempid = json['pk'];
    var tempName = json['fields']['name'];
    var tempExp = json['fields']['job_experience_years'];
    var tempDesc = json['fields']['job_description'];
    var tempBen = json['fields']['job_benefits'];
    var tempSal = json['fields']['job_salary'];
    var tempS1 = json['fields']['skills_needed_1'];
    var tempS2 = json['fields']['skills_needed_2'];
    var tempS3 = json['fields']['skills_needed_3'];
    var tempS4 = json['fields']['skills_needed_4'];
  ...
  factory Job.fromJsonJob(Map<String, dynamic> json) {
    var tempid = json['id'];
